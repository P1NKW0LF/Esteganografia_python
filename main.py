...
ocultar_mensaje('./Esteganografia_python/IMG_Original.png', 'Mensaje Super hyper secreto', './Esteganografia_python/resultados_ocultos/IMG_oculta.png')  #Ocultar mensaje en imagen
